...
LightPluginInstallerService::addOutputLevel
================



LightPluginInstallerService::addOutputLevel — Adds an output level.
...
public [LightPluginInstallerService::addOutputLevel](https://github.com/lingtalfi/Light_PluginInstaller/blob/master/doc/api/Ling/Light_PluginInstaller/Service/LightPluginInstallerService/addOutputLevel.md)(string $outputLevel) : void
