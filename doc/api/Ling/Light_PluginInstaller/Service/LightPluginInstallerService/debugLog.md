...
LightPluginInstallerService::debugLog
================



LightPluginInstallerService::debugLog — Sends a message to our "official" debug log.
...
public [LightPluginInstallerService::debugLog](https://github.com/lingtalfi/Light_PluginInstaller/blob/master/doc/api/Ling/Light_PluginInstaller/Service/LightPluginInstallerService/debugLog.md)(string $msg) : void
...
Source Code
===========
See the source code for method [LightPluginInstallerService::debugLog](https://github.com/lingtalfi/Light_PluginInstaller/blob/master/Service/LightPluginInstallerService.php#L537-L551)
